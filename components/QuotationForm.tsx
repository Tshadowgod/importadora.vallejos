...
function ResultCard({ result, onReset }: { result: QuotationResult; onReset: () => void }) {
  ...
  return (
    <div className="space-y-6 animate-[fadeIn_0.4s_ease]">
      ...
      <a
        href={`https://wa.me/59165073163?text=${encodeURIComponent(`Hola, acabo de cotizar mi vehículo en FROTED ADUANA (Cotización #${result.id}). Quisiera coordinar los trámites de importación.`)}`}
        target="_blank"
