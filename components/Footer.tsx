...
export default function Footer() {
  return (
    <footer id="contacto" className="bg-navy-950 border-t border-electric-500/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { label: "Inicio", href: "/" },
                { label: "Cotizar vehículo", href: "/cotizar" },
                { label: "Servicios", href: "/#servicios" },
                { label: "Nosotros", href: "/#nosotros" },
              ].map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-slate-400 hover:text-electric-400 text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-slate-400 text-sm">
                <svg className="w-4 h-4 text-electric-400 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/59165073163" className="hover:text-electric-400 transition-colors">
                  +591 65073163
                </a>
              </li>
              <li className="flex items-center gap-3 text-slate-400 text-sm">
                <svg className="w-4 h-4 text-electric-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>vallejosadhemar@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 text-slate-400 text-sm">
                <svg className="w-4 h-4 text-electric-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
