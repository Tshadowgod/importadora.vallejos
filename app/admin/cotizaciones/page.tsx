        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="flex items-center gap-2 bg-navy-800 hover:bg-navy-700 border border-electric-500/20 text-slate-300 hover:text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors"
            >
